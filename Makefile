...
# 
FILE_DA_CONSEGNARE=Makefile DATA/chatty.conf1 DATA/chatty.conf2 myScript.sh \
	client.c connections.c message.c ops.h server.h threadPool.c \
	conf.c connections.h message.h queue.c stat.c threadPool.h \
	conf.h genList.c messageHandler.c queue.h stat.h user.c \
	config.h genList.h messageHandler.h chatty.c stats.h user.h \
	testfile.sh testleaks.sh testconf.sh teststress.sh

# inserire il nome del tarball: es. NinoBixio
TARNAME=GemmaMartini
...
#
###################################################################
UNIX_PATH       = /tmp/chatterbox_sock_532769
...
OBJECTS		= connections.o message.o queue.o stat.o user.o \
			  conf.o genList.o messageHandler.o chatty.o threadPool.o

# aggiungere qui gli altri include 
INCLUDE_FILES   = conf.h connections.h message.h ops.h server.h stats.h \
				  user.h config.h genList.h messageHandler.h queue.h stat.h \
				  threadPool.h
